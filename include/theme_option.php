				...
				<div class="col1">
					<div class="main-nav">
						 <ul class="sub-menu categoryitems" style="display:block">
							...
							<li><i class="fa fa-columns"></i><a href="#tab-manage-announcement" onClick="toggleDiv(this.hash);return false;">Home Page Settings</a></li>
							<li><i class="fa fa-tasks"></i><a href="#tab-reviews-criteria" onClick="toggleDiv(this.hash);return false;">Reviews Criteria</a></li>
				...
				<div class="col2">
				  ...
				  <div id="tab-color">
                    ...
                    <ul class="form-elements noborder">
					  ...
					  <li class="to-field">
						<label class="to-label">Footer Background Color</label>
						<input type="text" name="footer_bg_color" value="<?php echo $px_theme_option['footer_bg_color']?>" class="bg_color" data-default-color="" />
					  </li>
					</ul>
					...
					<!--<input type="hidden" name="layout_option" value="wrapper_boxed" />-->
				  ...
				  <div id="tab-head-scripts" style="display:none;">
					...
					<div class="header-section" id="header_banner1">
					 <div class="opt-head">
					  <h4>Anncounement <?php echo $px_theme_option['announcement_title'];?></h4>
					  <div class="clear"></div>
					</div>
					<ul class="form-elements noborder">
					  <li class="to-label">
					  ...
					  <li class="to-field">
						<input type="text" name="announcement_title" size="20" value="<?php if(isset($px_theme_option['announcement_title'])) echo $px_theme_option['announcement_title'];?>" />
					...
					<ul class="form-elements noborder">
					  ...
					  <li class="to-field">
						<select name="announcement_blog_category" class="dropdown">
						  ...
						  <?php show_all_cats('', '', $px_theme_option['announcement_blog_category'], "category");?>
						</select>
					  </li>
					</ul>
					<ul class="form-elements noborder">
					  ...
					  <li class="to-field">
						<input type="text" name="announcement_no_posts" size="5" value="<?php if(isset($px_theme_option['announcement_no_posts'])) echo $px_theme_option['announcement_no_posts']?>" />
				  ...
				  <?php }?>
					 ...
					 <ul class="form-elements">
					  ...
					  <li class="to-field">
					   <label class="to-label">Top Strip</label>
						<input type="hidden" name="top_strip_switcher" value="" />
						<label class="cs-on-off">
							<input type="checkbox" name="top_strip_switcher" <?php if(isset($px_theme_option['top_strip_switcher']) && $px_theme_option['top_strip_switcher']=="on") echo "checked" ?> />
							<span></span>
						</label>
				 ...
				 <ul class="form-elements">
					...
					<label class="to-label">Social Icon</label>
					  <label class="cs-on-off">
						  <input type="checkbox" name="header_social_icons" <?php if (isset($px_theme_option['header_social_icons']) && $px_theme_option['header_social_icons'] == "on") echo "checked" ?>/>
						  <span></span>
					  </label>
					</li>
				  </ul>
				<ul class="form-elements">
				  ...
				  <ul class="form-elements">
					  ...
					  <li class="to-field">
						...
						<p>Paste your Html or Css Code here.<br><img src="http://www.ten28.com/yt.jpg"></p>
					  </li>
					</ul>
					</div>
				  ...
				  <div id="tab-manage-announcement" style="display:none;">
					...
					<?php if(!isset($px_theme_option['slider_type']) || empty($px_theme_option['slider_type'])){ $px_theme_option['slider_type'] = 'post_slider';}?>
					<ul class="form-elements">
						...
						<li class="to-field">
							<select name="slider_type" class="dropdown" onchange="javascript:home_slider_toggle(this.value)">
								 <option <?php if(isset($px_theme_option['slider_type']) and $px_theme_option['slider_type']=="post_slider"){echo "selected";}?> value="post_slider" >Post Slider</option>
								 <option <?php if(isset($px_theme_option['slider_type']) and $px_theme_option['slider_type']=="post_carousel"){echo "selected";}?> value="post_carousel" >Carousel Slider</option>
								 <option <?php if(isset($px_theme_option['slider_type']) and $px_theme_option['slider_type']=="post_slider2"){echo "selected";}?> value="post_slider2" >Post Listing</option>
								 <option <?php if(isset($px_theme_option['slider_type']) and $px_theme_option['slider_type']=="flex"){echo "selected";}?> value="flex" >Flex Slider</option>
								 <option <?php if(isset($px_theme_option['slider_type']) and $px_theme_option['slider_type']=="custom"){echo "selected";}?> value="custom" >Custom Slider</option>
							</select>
						</li>
					</ul>
					 <div class="form-elements" id="flex_sliders"  style=" <?php if($px_theme_option['slider_type'] == "flex"){echo "display:inline";} else{ echo "display:none";} ?>">
					<?php $slider_name = '';if(isset($px_theme_option['slider_name']) && $px_theme_option['slider_name'] <> ''){$slider_name = $px_theme_option['slider_name'];}?>
					<ul class="form-elements  noborder">
					...
					<ul class="form-elements  noborder" id="custom_slider" style=" <?php if(isset($px_theme_option['slider_type']) and $px_theme_option['slider_type'] == "custom"){echo "display:inline";} else{ echo "display:none";}?>" >
						<li class="to-label">
							<label>Custom Slider Short Code</label>
						</li>
						<li class="to-field">
							<input type="text" name="slider_id" class="txtfield" value="<?php if(isset( $px_theme_option['slider_id']))echo $px_theme_option['slider_id'];?>" />
					...
					<div class="form-elements" id="post_slider"  style=" <?php if(isset($px_theme_option['slider_type']) && ($px_theme_option['slider_type'] == "post_slider" || $px_theme_option['slider_type'] == "post_slider2" || $px_theme_option['slider_type'] == "post_carousel" || $px_theme_option['slider_type'] == "")){echo "display:inline";} else{ echo "display:none";}?>">
					<ul class="form-elements noborder">
					  <li class="to-label">
					  ...
					  <li class="to-field">
						<select name="slider_blog_category" class="dropdown">
						  <option value="">-- Select Category --</option>
						  <?php show_all_cats('', '', $px_theme_option['slider_blog_category'], "category");?>
						</select>
					  </li>
					</ul>
					<ul class="form-elements noborder" id="blog-slider-noposts"  style=" <?php if(isset($px_theme_option['slider_type']) && ($px_theme_option['slider_type'] == "post_slider" || $px_theme_option['slider_type'] == "post_carousel" || $px_theme_option['slider_type'] == "")){echo "display:inline";} else{ echo "display:none";}?>">
					  <li class="to-label">
						<label>Show no of posts</label>
					  </li>
					  <li class="to-field">
						<input type="text" name="slider_no_posts" size="5" value="<?php if(isset($px_theme_option['slider_no_posts'])) echo $px_theme_option['slider_no_posts'];?>" />
				  ...
				  <!-- Reviews Start -->
				  <div id="tab-reviews-criteria" style="display:none;">
					 <div class="theme-header"><h1>Reviews Criteria</h1></div>
					<div class="theme-help">
						<h4>Reviews Criteria Setting</h4>
						<p>Reviews Criteria Setting</p>
					</div>
					<?php
					for ( $j = 1; $j <= 10; $j++ ) {
					?>
						<ul class="form-elements">
							<li class="to-label"><label>Criteria <?php echo $j ?></label></li>
							<li class="to-field">
								<span style="line-height:30px; display:block; float:left; margin:0 5px">From </span>
								<select name="review_criteria_<?php echo $j ?>_1" style="width:15%">
									<option></option>
									<?php
										for ( $i = 1; $i <= 100; $i++ ) {
									?>
										<option value="<?php echo $i ?>" <?php if($px_theme_option['review_criteria_'.$j.'_1']==$i)echo "selected";?> ><?php echo $i ?> %</option>
									<?php }?>
								</select>
								<span style="line-height:30px; display:block; float:left; margin:0 5px">To </span>
								<select name="review_criteria_<?php echo $j ?>_2" style="width:15%">
									<option></option>
									<?php
										for ( $i = 1; $i <= 100; $i++ ) {
									?>
										<option value="<?php echo $i ?>" <?php if($px_theme_option['review_criteria_'.$j.'_2']==$i)echo "selected";?> ><?php echo $i ?> %</option>
									<?php }?>
								</select>
								<input style=" width:200px; margin-left:5px;" type="text" name="review_criteria_text_<?php echo $j ?>" value="<?php echo $px_theme_option['review_criteria_text_'.$j.'']?>" />
								<input style=" width:200px; margin-left:5px;" type="text" class="bg_color" name="review_criteria_text_color_<?php echo $j ?>" value="<?php if(isset($px_theme_option['review_criteria_text_color_'.$j.''])) echo $px_theme_option['review_criteria_text_color_'.$j.'']?>" />
							</li>
						</ul>
					<?php }?>
				</div>
				  <div id="tab-advertisement-banner" style="display:none;">
					...
					<li class="to-label">
					 ...
					 <li class="to-label">
					  ...
					  <li class="to-field">
						<input type="button" value="Add" onclick="javascript:px_add_banner_add('<?php echo admin_url()?>')" />
					  </li>
					</ul>
				  ...
				  <div id="tab-upload-languages" style="display:none;">
					...
					<ul class="form-elements noborder">
					  ...
					  <li class="to-field">
						<input type="text" name="trans_user_rating" value="<?php if(isset($px_theme_option['trans_user_rating']))echo $px_theme_option['trans_user_rating']; ?>" />
					  </li>
					</ul>
				  ...
				  <div id="tab-default-pages" style="display:none;">
					...
					<ul class="form-elements">
					  ...
					  <li class="to-field">
						<input type="text" class="small" name="default_excerpt_length" value="<?php if(isset($cs_theme_option['default_excerpt_length'])) echo $cs_theme_option['default_excerpt_length']?>" />
					  </li>
					</ul>
					<?php
						global $px_xmlObject;
