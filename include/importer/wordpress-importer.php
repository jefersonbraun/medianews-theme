...
class WP_Import extends WP_Importer {
	...
	function WP_Import() { 
			...
			echo '<div class="clear"></div><p class="import-start"><i class="fa fa-spinner fa-2"></i>' . __( 'Please Wait!! We are fetching dummy data for you. It can take 2 to 10 minutes depending upon data speed..', 'wordpress-importer' ) . '</p>';
	 }
