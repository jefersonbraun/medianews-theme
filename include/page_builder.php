...
if ( ! function_exists( 'px_page_bulider_add' ) ) {
...
if ( ! function_exists( 'px_page_bulider' ) ) {
 ...
 if ( ! function_exists( 'px_page_options' ) ) {
	function px_page_options( $post ) {
		...
		if ( $px_page_bulider <> "" ) {
			$px_xmlObject = new stdClass();
			$px_xmlObject = new SimpleXMLElement($px_page_bulider);//page_breadcrumbs
			   ...
			   <div class="option-sec" style="margin-bottom:0;">
				...
				<div class="elementhidden">
					...
					<ul class="form-elements  on-off-options noborder">
						...
						<li class="to-label"><label>Page Breadcrumbs</label></li>
						<li class="to-field">
							<label class="cs-on-off">
								<input type="checkbox" name="page_breadcrumbs" value="on" class="myClass" <?php if($page_breadcrumbs=='on')echo "checked"?> />
								<span></span>
							</label>
						</li>
								...
								if ( isset($_POST['px_orderby']) ) {
									...
									foreach ( $_POST['px_orderby'] as $count ){
										if ( $_POST['px_orderby'][$px_counter] == "gallery" ) {
											...
											$blog->addChild('var_pb_blog_desc', $_POST['var_pb_blog_desc'][$px_counter_blog]);
											$blog->addChild('var_pb_blog_order', $_POST['var_pb_blog_order'][$px_counter_blog] );
											$blog->addChild('var_pb_blog_image', $_POST['var_pb_blog_image'][$px_counter_blog]);
