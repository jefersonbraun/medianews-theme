...
<div class="element_size_<?php echo $px_node->gallery_albums_element_size;?>">
  ...
  <header class="pix-heading-title">
    <h2 class="pix-heading-color pix-section-title"><?php echo $px_node->px_gal_album_header_title;?></h2>
  </header>
  <?php }?>
  <!-- Latest Video Start -->
  <div class="latest-video"> 
    ...
    <div class="minus-column">
      ...
      <article <?php post_class($pos_class); ?>>
        <figure >
          <?php if($count_post_gallery <> ''){?>
          <a class="uppercase" href="<?php the_permalink();?>"><i class="fa fa-camera"></i><?php echo $count_post_gallery;?></a>
          <?php }?>
        ...
        <div class="text">
          <h2 class="pix-post-title"><a href="<?php the_permalink(); ?>">
            <?php the_title(); ?>
            </a></h2>
