...
<ul id="bbp-topic-<?php bbp_topic_id(); ?>" <?php bbp_topic_class(bbp_get_topic_id(), 'px-child-topics'); ?>>

	<li class="bbp-topic-title">
    
    <?php bbp_topic_author_link( array( 'type' => 'avatar', 'size' => 32 ) );?>
	...
	<li class="bbp-topic-freshness">
		...
		<p class="bbp-topic-meta">
        	<span class="bbp-topic-freshness-author">
				...
				<time><?php bbp_topic_freshness_link(); ?></time>
